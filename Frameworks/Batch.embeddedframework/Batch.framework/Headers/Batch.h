 ...
 */
+ (void)startWithAPIKey:(NSString *)key __attribute__((nonnull)) NS_AVAILABLE_IOS(6_0);
 ...
 */
+ (BOOL)handleURL:(NSURL *)url __attribute__((warn_unused_result, nonnull)) NS_AVAILABLE_IOS(6_0);
